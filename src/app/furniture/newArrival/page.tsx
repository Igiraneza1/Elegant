  ...
  return (
    <>
      <div className="bg-white">
        <section className="w-full px-4 sm:px-6 py-16 ml-30 mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-center ml-30 mb-10 gap-4">
              ...
              >
                <div className="relative mb-3 rounded-xl overflow-hidden bg-gray-100">
                  ...
                  {activeProductId === item.id && (
                    <button className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black text-white px-4 py-2 rounded-lg text-xs sm:text-sm font-medium z-10 transition-opacity duration-300">
                      Add to cart
                    </button>
                  )}
                </div>
